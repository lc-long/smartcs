...
def upgrade() -> None:
    ...
    op.drop_index(op.f('ix_customer_coupons_coupon_id'), table_name='customer_coupons')
    op.drop_index(op.f('ix_customer_coupons_customer_id'), table_name='customer_coupons')
    ...
    op.drop_table('users')
    op.drop_index(op.f('ix_customer_feedback_customer_id'), table_name='customer_feedback')
    ...
    op.drop_index(op.f('ix_loyalty_points_customer_id'), table_name='loyalty_points')
...
def downgrade() -> None:
    ...
    sa.Column('reference_id', sa.VARCHAR(length=50), autoincrement=False, nullable=True),
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['customer_id'], ['customers.id'], name=op.f('loyalty_points_customer_id_fkey')),
    ...
    sa.Column('ticket_id', sa.VARCHAR(length=36), autoincrement=False, nullable=True),
    sa.Column('type', sa.VARCHAR(length=20), autoincrement=False, nullable=False),
    sa.Column('category', sa.VARCHAR(length=50), autoincrement=False, nullable=False),
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['customer_id'], ['customers.id'], name=op.f('customer_feedback_customer_id_fkey')),
    sa.ForeignKeyConstraint(['order_id'], ['orders.id'], name=op.f('customer_feedback_order_id_fkey')),
    sa.ForeignKeyConstraint(['ticket_id'], ['support_tickets.id'], name=op.f('customer_feedback_ticket_id_fkey')),
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=False),
    sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['customer_id'], ['customers.id'], name=op.f('support_tickets_customer_id_fkey')),
    sa.ForeignKeyConstraint(['order_id'], ['orders.id'], name=op.f('support_tickets_order_id_fkey')),
    ...
    sa.ForeignKeyConstraint(['order_id'], ['orders.id'], name=op.f('invoices_order_id_fkey')),
    ...
    sa.Column('order_id', sa.VARCHAR(length=36), autoincrement=False, nullable=True),
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['coupon_id'], ['coupons.id'], name=op.f('customer_coupons_coupon_id_fkey')),
    sa.ForeignKeyConstraint(['customer_id'], ['customers.id'], name=op.f('customer_coupons_customer_id_fkey')),
    sa.ForeignKeyConstraint(['order_id'], ['orders.id'], name=op.f('customer_coupons_order_id_fkey')),
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['customer_id'], ['customers.id'], name=op.f('product_reviews_customer_id_fkey')),
    sa.ForeignKeyConstraint(['order_id'], ['orders.id'], name=op.f('product_reviews_order_id_fkey')),
    sa.ForeignKeyConstraint(['product_id'], ['products.id'], name=op.f('product_reviews_product_id_fkey')),
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['customer_id'], ['customers.id'], name=op.f('refunds_customer_id_fkey')),
    sa.ForeignKeyConstraint(['order_id'], ['orders.id'], name=op.f('refunds_order_id_fkey')),
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['shipment_id'], ['shipments.id'], name=op.f('shipment_tracking_shipment_id_fkey')),
