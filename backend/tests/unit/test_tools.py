...
import pytest
from backend.app.tools.billing.tools import (
    invoice_lookup,
    payment_history,
    billing_summary,
    order_payment_match,
...
from backend.app.tools.refund.tools import (
    order_lookup,
    refund_eligibility,
    process_refund,
...
class TestAdvancedTools:
    ...
    async def test_customer_feedback_lookup(self):
        ...
        assert "feedback" in result.lower() or "暂无" in result
